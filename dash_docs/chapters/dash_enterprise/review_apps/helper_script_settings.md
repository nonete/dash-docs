...
This script is responsible for storing all of the environment variables needed 
for CI.

You will need to update the following variables in `settings.py` file before 
you will be able to create review apps:
...
if os.getenv("CIRCLECI") == "true":
    ...
    PREFIX = "review-app-"
    # PREFIX is used by delete.py as a condition for purging review apps.
    # Only apps starting with the specified PREFIX will be deleted.
